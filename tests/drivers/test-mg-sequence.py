...
class TestMGSeq (unittest.TestCase):
    ...
    def testBasics (self):
        ...
        self.assert_(isinstance(instance.first(), sequence._ElementMap['first'].element2().typeDefinition()))
        self.assert_(isinstance(instance.second_opt(), sequence._ElementMap['second_opt'].element2().typeDefinition()))
        self.assert_(isinstance(instance.third(), sequence._ElementMap['third'].element2().typeDefinition()))
        self.assert_(isinstance(instance.fourth_0_2(), list))
        self.assertEqual(1, len(instance.fourth_0_2()))
        self.assert_(isinstance(instance.fourth_0_2()[0], sequence._ElementMap['fourth_0_2'].element2().typeDefinition()))
    ...
    def testMultiplesInMiddle (self):
        ...
        self.assert_(isinstance(instance.third(), altsequence._ElementMap['third'].element2().typeDefinition()))
        self.assertEqual(xml, ToDOM(instance).toxml())
    ...
    def testMultiplesAtStart (self):
        ...
        self.assert_(isinstance(instance.third(), altsequence._ElementMap['third'].element2().typeDefinition()))
        self.assertEqual(xml, ToDOM(instance).toxml())
        instance = altwrapper(first=[ altsequence._ElementMap['first'].element2()(), altsequence._ElementMap['first'].element2()() ], third=[altsequence._ElementMap['third'].element2()()])
        self.assertEqual(xml, ToDOM(instance).toxml())
    ...
    def testMissingAtStart (self):
        ...
        instance = altwrapper(third=[altsequence._ElementMap['third'].element2()()])
    ...
    def testTooManyAtStart (self):
        ...
        dom = pyxb.utils.domutils.StringToDOM(xml)
        self.assertRaises(UnrecognizedContentError, altwrapper.createFromDOM, dom.documentElement)
        instance = altwrapper(first=[ altsequence._ElementMap['first'].element2()(), altsequence._ElementMap['first'].element2()(), altsequence._ElementMap['first'].element2()() ], third=[altsequence._ElementMap['third'].element2()()])
        self.assertRaises(pyxb.DOMGenerationError, ToDOM, instance)
