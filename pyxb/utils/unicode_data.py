...
BlockMap = {
  ...
  'PrivateUse' : (
     (0x100000, 0x10fffd), (0x0f0000, 0x0ffffd), (0x00e000, 0x00f8ff),
  ),
  'Runic' : (
     (0x0016a0, 0x0016ff),
  ),
  ...
  'Specials' : (
     (0x00fff0, 0x00fffd), (0x00feff, 0x00feff),
  ),
...
PropertyMap = {
  # C: 206 codepoints
  'C'  : ( (0x000000, 0x00001f), (0x00007f, 0x00009f), (0x00070f, 0x00070f),
           (0x00180b, 0x00180e), (0x00200c, 0x00200f), (0x00202a, 0x00202e),
           (0x00206a, 0x00206f), (0x00d800, 0x00d800), (0x00db7f, 0x00db80),
           (0x00dbff, 0x00dc00), (0x00dfff, 0x00e000), (0x00f8ff, 0x00f8ff),
           (0x00feff, 0x00feff), (0x00fff9, 0x00fffb), (0x01d173, 0x01d17a),
           (0x0e0001, 0x0e0001), (0x0e0020, 0x0e007f), (0x0f0000, 0x0f0000),
           (0x0ffffd, 0x0ffffd), (0x100000, 0x100000), (0x10fffd, 0x10fffd), ),
  # Cc: 65 codepoints
  'Cc' : ( (0x000000, 0x00001f), (0x00007f, 0x00009f), ),
  # Cf: 129 codepoints
  'Cf' : ( (0x00070f, 0x00070f), (0x00180b, 0x00180e), (0x00200c, 0x00200f),
           (0x00202a, 0x00202e), (0x00206a, 0x00206f), (0x00feff, 0x00feff),
           (0x00fff9, 0x00fffb), (0x01d173, 0x01d17a), (0x0e0001, 0x0e0001),
           (0x0e0020, 0x0e007f), ),
  # Co: 6 codepoints
  'Co' : ( (0x00e000, 0x00e000), (0x00f8ff, 0x00f8ff), (0x0f0000, 0x0f0000),
           (0x0ffffd, 0x0ffffd), (0x100000, 0x100000), (0x10fffd, 0x10fffd), ),
  # Cs: 6 codepoints
  'Cs' : ( (0x00d800, 0x00d800), (0x00db7f, 0x00db80), (0x00dbff, 0x00dc00),
           (0x00dfff, 0x00dfff), ),
  # L: 8403 codepoints
  'L'  : ( (0x000041, 0x00005a), (0x000061, 0x00007a), (0x0000aa, 0x0000aa),
           ...
           (0x0031a0, 0x0031b7), (0x003400, 0x003400), (0x004db5, 0x004db5),
           (0x004e00, 0x004e00), (0x009fa5, 0x009fa5), (0x00a000, 0x00a48c),
           (0x00ac00, 0x00ac00), (0x00d7a3, 0x00d7a3), (0x00f900, 0x00fa2d),
           ...
           (0x01d7aa, 0x01d7c2), (0x01d7c4, 0x01d7c9), (0x020000, 0x020000),
           (0x02a6d6, 0x02a6d6), (0x02f800, 0x02fa1d), ),
  # Ll: 1331 codepoints
  'Ll' : ( (0x000061, 0x00007a), (0x0000aa, 0x0000aa), (0x0000b5, 0x0000b5),
  ...
  # Lm: 46 codepoints
  'Lm' : ( (0x0002b0, 0x0002b8), (0x0002bb, 0x0002c1), (0x0002d0, 0x0002d1),
  ...
  # Lo: 5827 codepoints
  'Lo' : ( (0x0001bb, 0x0001bb), (0x0001c0, 0x0001c3), (0x0005d0, 0x0005ea),
           ...
           (0x003400, 0x003400), (0x004db5, 0x004db5), (0x004e00, 0x004e00),
           (0x009fa5, 0x009fa5), (0x00a000, 0x00a48c), (0x00ac00, 0x00ac00),
           (0x00d7a3, 0x00d7a3), (0x00f900, 0x00fa2d), (0x00fb1d, 0x00fb1d),
           (0x00fb1f, 0x00fb28), (0x00fb2a, 0x00fb36), (0x00fb38, 0x00fb3c),
           (0x00fb3e, 0x00fb3e), (0x00fb40, 0x00fb41), (0x00fb43, 0x00fb44),
           (0x00fb46, 0x00fbb1), (0x00fbd3, 0x00fd3d), (0x00fd50, 0x00fd8f),
           (0x00fd92, 0x00fdc7), (0x00fdf0, 0x00fdfb), (0x00fe70, 0x00fe72),
           ...
           (0x00ffca, 0x00ffcf), (0x00ffd2, 0x00ffd7), (0x00ffda, 0x00ffdc),
           (0x010300, 0x01031e), (0x010330, 0x010349), (0x020000, 0x020000),
           (0x02a6d6, 0x02a6d6), (0x02f800, 0x02fa1d), ),
  # Lt: 31 codepoints
  'Lt' : ( (0x0001c5, 0x0001c5), (0x0001c8, 0x0001c8), (0x0001cb, 0x0001cb),
           (0x0001f2, 0x0001f2), (0x001f88, 0x001f8f), (0x001f98, 0x001f9f),
           (0x001fa8, 0x001faf), (0x001fbc, 0x001fbc), (0x001fcc, 0x001fcc),
           (0x001ffc, 0x001ffc), ),
  # Lu: 1168 codepoints
  'Lu' : ( (0x000041, 0x00005a), (0x0000c0, 0x0000d6), (0x0000d8, 0x0000de),
           ...
           (0x01d790, 0x01d7a8), ),
  # M: 605 codepoints
  'M'  : ( (0x000300, 0x00034e), (0x000360, 0x000362), (0x000483, 0x000486),
  ...
  # Mc: 126 codepoints
  'Mc' : ( (0x000903, 0x000903), (0x00093e, 0x000940), (0x000949, 0x00094c),
  ...
  # Me: 10 codepoints
  'Me' : ( (0x000488, 0x000489), (0x0006dd, 0x0006de), (0x0020dd, 0x0020e0),
           (0x0020e2, 0x0020e3), ),
  # Mn: 469 codepoints
  'Mn' : ( (0x000300, 0x00034e), (0x000360, 0x000362), (0x000483, 0x000486),
           ...
           (0x01d1aa, 0x01d1ad), ),
  # N: 486 codepoints
  'N'  : ( (0x000030, 0x000039), (0x0000b2, 0x0000b3), (0x0000b9, 0x0000b9),
  ...
  # Nd: 248 codepoints
  'Nd' : ( (0x000030, 0x000039), (0x000660, 0x000669), (0x0006f0, 0x0006f9),
  ...
  # Nl: 53 codepoints
  'Nl' : ( (0x0016ee, 0x0016f0), (0x002160, 0x002183), (0x003007, 0x003007),
           (0x003021, 0x003029), (0x003038, 0x00303a), (0x01034a, 0x01034a), ),
  # No: 185 codepoints
  'No' : ( (0x0000b2, 0x0000b3), (0x0000b9, 0x0000b9), (0x0000bc, 0x0000be),
  ...
  # P: 298 codepoints
  'P'  : ( (0x000021, 0x000023), (0x000025, 0x00002a), (0x00002c, 0x00002f),
  ...
  # Pc: 11 codepoints
  'Pc' : ( (0x00005f, 0x00005f), (0x00203f, 0x002040), (0x0030fb, 0x0030fb),
           (0x00fe33, 0x00fe34), (0x00fe4d, 0x00fe4f), (0x00ff3f, 0x00ff3f),
           (0x00ff65, 0x00ff65), ),
  # Pd: 17 codepoints
  'Pd' : ( (0x00002d, 0x00002d), (0x0000ad, 0x0000ad), (0x00058a, 0x00058a),
  ...
  # Pe: 37 codepoints
  'Pe' : ( (0x000029, 0x000029), (0x00005d, 0x00005d), (0x00007d, 0x00007d),
  ...
  # Pf: 4 codepoints
  'Pf' : ( (0x0000bb, 0x0000bb), (0x002019, 0x002019), (0x00201d, 0x00201d),
           (0x00203a, 0x00203a), ),
  # Pi: 6 codepoints
  'Pi' : ( (0x0000ab, 0x0000ab), (0x002018, 0x002018), (0x00201b, 0x00201c),
           (0x00201f, 0x00201f), (0x002039, 0x002039), ),
  # Po: 185 codepoints
  'Po' : ( (0x000021, 0x000023), (0x000025, 0x000027), (0x00002a, 0x00002a),
  ...
  # Ps: 38 codepoints
  'Ps' : ( (0x000028, 0x000028), (0x00005b, 0x00005b), (0x00007b, 0x00007b),
  ...
  # S: 2841 codepoints
  'S'  : ( (0x000024, 0x000024), (0x00002b, 0x00002b), (0x00003c, 0x00003e),
  ...
  # Sc: 31 codepoints
  'Sc' : ( (0x000024, 0x000024), (0x0000a2, 0x0000a5), (0x0009f2, 0x0009f3),
           (0x000e3f, 0x000e3f), (0x0017db, 0x0017db), (0x0020a0, 0x0020af),
           (0x00fe69, 0x00fe69), (0x00ff04, 0x00ff04), (0x00ffe0, 0x00ffe1),
           (0x00ffe5, 0x00ffe6), ),
  # Sk: 69 codepoints
  'Sk' : ( (0x00005e, 0x00005e), (0x000060, 0x000060), (0x0000a8, 0x0000a8),
           ...
           (0x00ffe3, 0x00ffe3), ),
  # Sm: 309 codepoints
  'Sm' : ( (0x00002b, 0x00002b), (0x00003c, 0x00003e), (0x00007c, 0x00007c),
  ...
  # So: 2432 codepoints
  'So' : ( (0x0000a6, 0x0000a7), (0x0000a9, 0x0000a9), (0x0000ae, 0x0000ae),
  ...
  # Z: 19 codepoints
  'Z'  : ( (0x000020, 0x000020), (0x0000a0, 0x0000a0), (0x001680, 0x001680),
           (0x002000, 0x00200b), (0x002028, 0x002029), (0x00202f, 0x00202f),
           (0x003000, 0x003000), ),
  # Zl: 1 codepoints
  'Zl' : ( (0x002028, 0x002028), ),
  # Zp: 1 codepoints
  'Zp' : ( (0x002029, 0x002029), ),
  # Zs: 17 codepoints
  'Zs' : ( (0x000020, 0x000020), (0x0000a0, 0x0000a0), (0x001680, 0x001680),
