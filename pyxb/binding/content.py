...
class ContentModel_mixin (pyxb.cscRoot):
    ...
    def _validate (self, symbol_set, output_sequence):
        ...
        @param symbol_set: A map from L{ElementDeclaration} instances to a list of
        ...
        tuples C{( eu, val )} where C{eu} is an L{ElementDeclaration} from the set of
...
class ElementDeclaration (ContentState_mixin, ContentModel_mixin):
    ...
    # CM.newState:ElementDeclaration
    def newState (self, parent_particle_state):
...
class ParticleModel (ContentModel_mixin):
    ...
    def validate (self, symbol_set):
        ...
        C{eu} is an L{ElementDeclaration} from the set of symbol keys, and C{val} is a
