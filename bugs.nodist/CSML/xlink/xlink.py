...
# Generated 2009-06-23 16:31:06.534108 by PyWXSB version UNSPECIFIED
import pyxb.binding
...
_STD_ANON_1.new = _STD_ANON_1._CF_enumeration.addEnumeration(unicode_value=u'new')
_STD_ANON_1.replace = _STD_ANON_1._CF_enumeration.addEnumeration(unicode_value=u'replace')
_STD_ANON_1.embed = _STD_ANON_1._CF_enumeration.addEnumeration(unicode_value=u'embed')
...
_STD_ANON_2.onLoad = _STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'onLoad')
_STD_ANON_2.onRequest = _STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'onRequest')
